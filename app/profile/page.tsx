  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto py-8">
      <MotionDiv
        ...
        className="space-y-2"
      >
        <h2 className="text-3xl font-bold tracking-tight gradient-text">Your Profile</h2>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            <Avatar className="h-16 w-16 border border-primary/50">
              <AvatarImage src="/user-placeholder.png" alt={`${userData.first_name} ${userData.last_name}`} />
              <AvatarFallback>
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-sm text-muted-foreground">@{userData.user_name}</p>
